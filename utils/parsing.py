...
def parse_train_args():
    ...
    # edited below to work with a folder I created
    parser.add_argument('--log_dir', type=str, default='train_experiments', help='Folder in which to save model and logs')
    ...
    parser.add_argument('--dataset', type=str, default='pdbbind', help='The dataset you are using to train, not the folder **Changed by Kamal**')
